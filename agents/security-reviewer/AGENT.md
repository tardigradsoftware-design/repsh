...
goal: Find exploitable issues across web+LLM surfaces with severity-ranked actionable reports
...
## Mission
Find exploitable issues across web+LLM surfaces with severity-ranked actionable reports.
